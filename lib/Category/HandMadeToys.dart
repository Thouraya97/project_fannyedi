...
class HandMadeToys extends StatefulWidget {
  String currentEmail;

  HandMadeToys(this.currentEmail);
  @override
  _HandMadeToysState createState() => _HandMadeToysState(currentEmail);
}

class _HandMadeToysState extends State<HandMadeToys> {
  ...
  _HandMadeToysState(this.currentEmail);
...
,
 ...
 StreamBuilder(
              ...
              .collection("Products")
              .where('category', isEqualTo: 'Hand Made toys')
              .get()
              .asStream(),
