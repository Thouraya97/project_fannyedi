...
class Knittings extends StatefulWidget {
   String currentEmail;
  Knittings(this.currentEmail);
  @override
  _KnittingsState createState() => _KnittingsState(currentEmail);
}

class _KnittingsState extends State<Knittings> {
  ...
  _KnittingsState(this.currentEmail);
...
,
 ...
 StreamBuilder(
              ...
              .collection("Products")
              .where('category', isEqualTo: 'knitting')
              .get()
              .asStream(),
